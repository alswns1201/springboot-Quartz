...
Spring Boot 기반의 Quartz Scheduler 예제 프로젝트로, 동적으로 Job을 등록, 조회, 삭제할 수 있는 기능을 제공합니다.
...
SimpleTriggerListener에서 triggerFired 시 남은 실행 횟수를 차감하고 SchedulerService를 통해 상태를 갱신.
